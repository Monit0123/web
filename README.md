...
| `profile.html` | Member dashboard — membership, today overview, training, diet plans + calorie tracker + food database, programs, progress photos, attendance, coach corner, AI assistant, personal goals, challenges & leaderboards, notification center |
...
- **Cache busting.** Stylesheet and script are linked as `?v=33`. Bump that
